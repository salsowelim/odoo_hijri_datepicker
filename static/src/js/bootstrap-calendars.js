...
/*
  ...
  - Adding the possibilty to initialize new CDateTime from object.
  - Rename global variable to "moment_hijri" to work in harmony with moment.js
  - support format of type MM/DD/YYYY HH:mm:ss, (only capital S was supported,not s) by updating _map_specifiers function.
  - update compareTo function to support second-level comparison.
*/
